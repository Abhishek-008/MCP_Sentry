                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 shadow-2xl shadow-emerald-900/10">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full py-3 px-4 bg-gray-800 hover:bg-gray-750 border border-gray-700 hover:border-gray-600 rounded-lg transition-colors flex items-center justify-center space-x-3 mb-6 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loading ? (
